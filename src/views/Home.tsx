		...
		>
			...
			>
				...
				>
					<a
						href="#portfolio"
						className="group relative px-8 py-3.5 bg-alvaro-primary text-alvaro-dark font-semibold rounded-xl overflow-hidden transition-all duration-300 active:scale-[0.97] hover:shadow-[0_0_30px_-5px_rgba(212,168,83,0.3)]"
					>
